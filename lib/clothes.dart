...
class Clothing {
  ...
  Clothing.usingLink(this.uid, this.filename, this.link, this.category, this.sleeves, this.color, this.materials,this.item, this.isLaundry, this.inLaundryFor, this.isFavorite);

  Clothing.full(this.uid, this.path, this.filename, this.link, this.category, this.sleeves, this.color, this.materials,this.item, this.isLaundry, this.inLaundryFor, this.isFavorite);

  Clothing.clone(Clothing other) : this.full(other.uid, other.path, other.filename, other.link, other.category, other.sleeves, other.color, other.materials, other.item, other.isLaundry, other.inLaundryFor,other.isFavorite);
